...
public class Search_Frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 10, 320, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/logo1.png"))); // NOI18N
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, -2, 160, 50));
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 370, -1, -1));
        ...
        jPanel3.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 70, 130, -1));

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTH;
        jPanel2.add(jPanel3, gridBagConstraints);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/checkin1.jpg"))); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
    ...
    public void checkSevenDay()
    {
        if(jCheckBox1.isSelected())
        {
            sql="SELECT a.flightno,a.flightdate,a.bcsavailable,a.xcsavailable,a.ecsavailable,b.deptime FROM "
                    + "scheduledflights a,flights1 b WHERE a.flightno IN (SELECT flightno FROM flights1 WHERE aircrafttypeID IN "
                    + "(SELECT aircraft.aircrafttypeID FROM aircraft WHERE aircrafttypeID IN "
                    + "(SELECT aircrafttypeID FROM sector, flights1 WHERE source LIKE '"+ origin
                    + "' AND destination LIKE '" + target + "' AND sector.sectorID = flights1.sectorID))) "
                    + "AND a.flightno=b.flightno ORDER BY a.flightdate";   
            System.out.println(sql);
        }
        else
        {
            sql="SELECT  a.flightno,a.flightdate,a.bcsavailable,a.xcsavailable,a.ecsavailable,b.deptime FROM scheduledflights a,flights1 b WHERE a.flightno IN"
                + " (SELECT flightno FROM flights1 WHERE aircrafttypeID IN "
                + "(SELECT aircraft.aircrafttypeID FROM aircraft WHERE aircrafttypeID IN "
                + "(SELECT aircrafttypeID FROM sector,flights1 WHERE source LIKE '"+ origin 
                + "' AND destination LIKE '" + target + "' AND sector.sectorID=flights1.sectorID) "+search
        ...
        if (fclass.equals("Business")) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    strdtver1 = (String) sdf.format(jDateChooser1.getDate());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try
        {
            ...
            else
            {
                ...
                bf.getSearchData(pdt, obj2, obj3, porigin, ptarget, pfclass);
                bf.setVisible(true);
                this.dispose();
